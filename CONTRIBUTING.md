...
issues](https://github.com/joebl4ck/litecoinz-copay-wallet/issues) in order to learn if the issue is already reported. It could be fixed already.

Please also check our the copay [FAQ](https://github.com/joebl4ck/litecoinz-copay-wallet/wiki/).
...
To open an issue go to [Github Issues](https://github.com/joebl4ck/litecoinz-copay-wallet/issues).
